...
exports["default"] = (function () { return __awaiter(void 0, void 0, void 0, function () {
    var username, baseUrl, data, $, script, script_regex, user, edges, posts, instagram_data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                user = JSON.parse(script_regex[1]).entry_data.ProfilePage[0].graphql.user;
                edges = JSON.parse(script_regex[1]).entry_data.ProfilePage[0].graphql.user.edge_owner_to_timeline_media.edges;
                posts = edges.map(function (_a) {
                    var node = _a.node;
                    return ({
                        id: node.id,
